...
//  TodoProduct
//
//  Created by Keitaro Kawahara on 2022/09/11.
//
...
class EditViewController: UIViewController, UITextFieldDelegate  {
    ...
    @IBAction func addButtonPressed() {
        ...
        let targets = realm.objects(Item.self).filter("title == %@", listTitle)
        ...
        try! realm.write {
          for target in targets {
              ...
              target.detail = textView.text!
              target.date = datePickerTextField.text!
          }
